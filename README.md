...
We'll split up into two groups--one for creating and using badges and one for building the badge tool and integration. See files on Badge Creation and [Build and Infrastructure] (docs/Build-and-Infrastructure.md).
